...
| ------- | ---------- | --- | ----------------------------- |
| —       | —          | —   | Working through Academy first |

---

## Methodology

Reusable enumeration checklists and approach notes live in the [`methodology/`](./methodology/) folder — built up progressively as patterns emerge across machines.
